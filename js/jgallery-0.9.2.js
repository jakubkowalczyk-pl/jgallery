...
( function( $ ) {
    $.fn.jGallery = function( options ) {
        ...
        function jGallery( $this ) {
            ...
            if ( $.fn.jGalleryOptions[ intId ].disabledOnIE7AndOlder && $.browser.msie && $.browser.version < 8 ) {
                return;
            }
            ...
            function progress( $this ) {
                ...
                $this.start = function( width, success ) {
                    $this.animate( {
                        width: width
                    }, parseInt( $.fn.jGalleryOptions[ intId ].slideshowInterval ) * 1000, 'linear', success );
                    return $this;
                };
            ...
            function setVariables() {
                ...
                if ( $albums.length == 0 ) {
                    $albums = $thumbnails.find( '.container-inner' ).addClass( 'active' );                    
                }
            }
            ...
            function generateThumbs() {
                ...
                var intI = 1;
                var intJ = 1;
                var $thumbnailsContainerInner = $( '.jgallery' ).eq( -1 ).find( '.thumbnails .container-inner' );
            ...
            function init() {
                ...
                ( function() {                    
                    if ( booIsAlbums ) {
                        ...
                        ' );
                        $thumbsChangeAlbum = new $iconChangeAlbum( $zoomContainer.find( '.change-album' ) );
                        ...
                        $thumbnails.append( $thumbsChangeAlbum.outerHtml() );
                        $thumbsChangeAlbum = new $iconChangeAlbum( $thumbsChangeAlbum.add( $thumbnails.children( ':last-child' ) ) );
                    }
                } )();
            ...
            function initThumb() {
                $thumbnails.removeClass( 'square number images thumbnails-left thumbnails-right thumbnails-top thumbnails-bottom thumbnails-horizontal thumbnails-vertical' );
                $thumbnails.addClass( 'thumbnails-' + $.fn.jGalleryOptions[ intId ].thumbnailsPosition );
                if ( isVerticalThumbs() ) {
                ...
                if ( $.fn.jGalleryOptions[ intId ].thumbType == 'image' ) {
                    initThumbImages();
                }
                if ( $.fn.jGalleryOptions[ intId ].thumbType == 'square' ) {
                    initThumbSquare();
                }
                if ( $.fn.jGalleryOptions[ intId ].thumbType == 'number' ) {
                    initThumbNumber();
                }
            }
                ...
                $( 'head' ).append( '\
                    <style type="text/css">\n\
                        .jgallery .thumbnails a {\n\
                            width: ' + $.fn.jGalleryOptions[ intId ].thumbWidth + 'px;\n\
                            height: ' + $.fn.jGalleryOptions[ intId ].thumbHeight + 'px;\n\
                            font-size: ' + $.fn.jGalleryOptions[ intId ].thumbHeight + 'px;\n\
                        }\n\
                        .jgallery .thumbnails.full-screen a {\n\
                            width: ' + $.fn.jGalleryOptions[ intId ].thumbWidthOnFullScreen + 'px;\n\
                            height: ' + $.fn.jGalleryOptions[ intId ].thumbHeightOnFullScreen + 'px;\n\
                            font-size: ' + $.fn.jGalleryOptions[ intId ].thumbHeightOnFullScreen + 'px;\n\
                        }\n\
                        .jgallery .thumbnails-horizontal {\n\
                            height: ' + parseInt( $.fn.jGalleryOptions[ intId ].thumbHeight + 2 ) + 'px;\n\
                        }\n\
                        .jgallery .thumbnails-vertical {\n\
                            width: ' + parseInt( $.fn.jGalleryOptions[ intId ].thumbWidth + 2 ) + 'px;\n\
                        }\n\
                        .jgallery .thumbnails-top.hidden {\n\
                            top: -' + $.fn.jGalleryOptions[ intId ].thumbHeight + 'px;\n\
                        }\n\
                        .jgallery .thumbnails-bottom.hidden {\n\
                            bottom: -' + $.fn.jGalleryOptions[ intId ].thumbHeight + 'px;\n\
                        }\n\
                        .jgallery .thumbnails-left.hidden {\n\
                            left: -' + $.fn.jGalleryOptions[ intId ].thumbWidth + 'px;\n\
                        }\n\
                        .jgallery .thumbnails-right.hidden {\n\
                            right: -' + $.fn.jGalleryOptions[ intId ].thumbWidth + 'px;\n\
                        }\n\
                    </style>\n\
                ' ); 
                if ( initialized() ) {
            ...
            function isHorizontalThumbs() {
                return $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'top' || $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'bottom';
            }

            function isVerticalThumbs() {
                return $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'left' || $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'right';
            }
            ...
            function getCanvasRatioWidthToHeight() {
                ...
                if ( isHorizontalThumbs() ) {
                    ...
                    intCanvasHeight = $jGallery.height() - $thumbnails.outerHeight( true );
                }
                else if ( isVerticalThumbs() ) {
                    intCanvasWidth = $jGallery.width() - $thumbnails.outerWidth( true );
            ...
            function refreshZoomContainerSize() {
                ...
                $zoomContainer.css( {
                    'width': isVerticalThumbs() ? $jGallery.width() - $thumbnails.outerWidth( true ) : 'auto',
                    'height': isHorizontalThumbs() ? $jGallery.height() - $thumbnails.outerHeight( true ) - intNavBottomHeight : $jGallery.height() - intNavBottomHeight,
                    'margin-top': $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'top' ? $thumbnails.outerHeight( true ) : 0,
                    'margin-left': $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'left' ? $thumbnails.outerWidth( true ) : 0,
                    'margin-right': $.fn.jGalleryOptions[ intId ].thumbnailsPosition == 'right' ? $thumbnails.outerWidth( true ) : 0
                } );
            }
            ...
            function zoomFitToWindow() {
                ...
                $img.css( {
                    ...
                    'min-width': 0,
                    'min-height': 0,
                    'max-width': isVerticalThumbs() ? $jGallery.width() - $thumbnails.outerWidth( true ) : $jGallery.width(),
                    'max-height': isHorizontalThumbs() ? $jGallery.height() - $thumbnails.outerHeight( true ) - intNavBottomHeight : $jGallery.height() - intNavBottomHeight
                } );                
                $img.css( {
            ...
            function zoom100Percent() {
                ...
                $img.css( {
                    'max-width': 'none',
                    'max-height': 'none',                    
                    'min-width': isVerticalThumbs() ? $jGallery.width() - $thumbnails.outerWidth( true ) : $jGallery.width(),
                    'min-height': isHorizontalThumbs() ? $jGallery.height() - $thumbnails.outerHeight( true ) - intNavBottomHeight : $jGallery.height() - intNavBottomHeight
                } );
                if ( fltZoomRatioWidthToHeight / getCanvasRatioWidthToHeight() > 1 ) {
                    ...
                    $img.css( {
                        'width': isVerticalThumbs() ? $jGallery.width() - $thumbnails.outerWidth( true ) : $jGallery.width(),
                        'height': 'auto'
                    } );
                }
                $img.css( {
            ...
            function refreshHorizontalThumbsNav() {
                ...
                var intThumbsWidth = $.fn.jGalleryOptions[ intId ].thumbType == 'image' ? $thumbnailsA.outerWidth( true ) * $album.find( 'img' ).length : $thumbnailsA.outerWidth( true ) * $album.find( 'a' ).length;
            ...
            function showPhoto( $a ) {
                ...
                changeThumbsViewToBar();
                if ( booIsAlbums ) {
                    if ( $thumbsChangeAlbum.getTitle() == '' ) {
                        $thumbsChangeAlbum.setTitle( $a.parents( '.album' ).eq( 0 ).attr( 'data-jgallery-album-title' ) );
                    }
                }
                setActiveThumb( $a );
            ...
            function setActiveAlbum( $album ) {
                ...
                $thumbsChangeAlbum.setTitle( $album.attr( 'data-jgallery-album-title' ) );
                refreshThumbsNav();
                if ( ! $thumbnails.is( '.full-screen' ) && $jGallery.is( ':visible' ) ) {
